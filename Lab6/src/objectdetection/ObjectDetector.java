 ...
 * @author ychen225, Peter Henderson
 *
 */
public class ObjectDetector {
	...
	/**
	 * Updated searching code, this looks for the item based purely on distances not finding the peaks
	 * @param colorID
	 * @return
	 */
...
//					return -1;
	...
	/**
	 * This searches for an item by looking for peaks and finding the center of a styrofoam block
	 * @param colorID
	 * @return
	 */
